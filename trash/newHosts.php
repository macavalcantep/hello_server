...
<html>
    ...
    echo "<div class='device-box'><p>" . $macs['hostname'] . "<p><div>";
    ...
    $hostnameToUpdate = $macs['hostname'];
    $ipToUpdate = $macs['ip'];
...
?>
            ...
            <!-- <td> -->
                <center>
                <?php //echo $lock_in ?>
                    <!-- <a target="_blank" onClick="window.open('main/moreInfo.php?host=<?=$macs['hostname']?>&p=pc','ping',' width=900 height=700')">
        ...
        if($total_results == 0 ) {
          ...
          <nav class="next-icons" aria-label="Page navigation example">
            <ul class="pagination">
              <li class="page-item">
                <?php
                if($previous != 0 ) { ?>
