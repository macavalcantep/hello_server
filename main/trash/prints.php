...
$querL = " select * from prints limit $begin, $pageQT";
    ...
    <body>
        ...
        <?php 
            ...
            <?php while ($prints = mysqli_fetch_array($resultL)) {
                ...
                echo "<td><center>" . $prints['ip'] . "</center></td>";
            ...
            <td>
                <center>
                <?php echo $lock_in ?>
                      <a target="_blank" onClick="window.open('moreInfo.php?host=<?=$prints['hostname']?>&p=pt','ping',' width=900,height=500')">
